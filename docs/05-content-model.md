...
Шаблоны с плейсхолдерами `{n}`, `{item}`, `{needs}`. Ключи фиксированы и перечислены в
`FeedbackKey` (enum в `:domain`), тест проверяет, что для каждого ключа есть текст.

```json
{
  "purchase.mandatory": "Монеты −{n}. {item} — это нужное. Финни доволен!",
  "purchase.optional": "Монеты −{n}. {item} порадовал Финни. Помни про план!",
  "purchase.over_plan_warning": "Ты планировал на желаемое {plan}, а потратишь {fact}. Это твой выбор.",
  "insufficient.title": "Не хватает {n} монет",
  "insufficient.option.task": "Выполни задание «{task}» и получи {n}",
  "insufficient.option.withdraw": "Взять {n} из копилки",
  "insufficient.option.cheaper": "Выбрать дешевле: {item} за {n}",
  "insufficient.option.wait": "Подождать следующую неделю",
  "deposit": "Отложил {n}. До цели осталось {remaining}. Финни гордится тобой!",
  "withdraw": "Ты взял {n} из копилки. Это нормально, если очень нужно.",
  "period.a_ok": "Ты купил всё нужное — Финни сыт и ухожен",
  "period.a_fail": "Финни не хватило: {needs}. Купи это первым на новой неделе",
  "period.b_ok": "Ты уложился в план на желаемое",
  "period.b_fail": "На желаемое ушло больше плана. В следующий раз сверься с планом",
  "period.c_ok": "Ты отложил {n} — до цели ближе",
  "period.c_fail": "Копилка не пополнилась. Попробуй отложить хотя бы 5",
  "stage.up": "Финни подрос! Это потому, что ты хорошо планируешь",
  "mood.hungry": "Голоден: на этой неделе не было еды",
  "mood.unkempt": "Хочет ухода: не было ухода",
